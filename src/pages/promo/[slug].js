...
const promoClick = () => {
  logEvent('Promo', 'clicked', 'PromoDetailPage')
}

export default function PromoTemplate(props) {
  ...
  return (
    ...
    <article className="blog" onClick={promoClick}>
...
PromoTemplate.getInitialProps = async function(ctx) {
